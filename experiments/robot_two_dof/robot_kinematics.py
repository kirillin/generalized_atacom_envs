...
def test_kinematics():
    kinematics = Kinematics(env_dir + '/models/two_dof.urdf')


    # print(q)
    # print(kinematics.print_fk())
    
    # print()
    # print(kinematics.position_lower_limit)
    # print(kinematics.position_upper_limit)
    
    # frame_idx = 10
    # print(kinematics.get_frame(frame_idx))
    # print(kinematics.get_jacobian(frame_idx))

    # print()
    # print(kinematics.inverse_pos(np.array([1,0,0]), q, frame_idx))

    # q = np.random.uniform([-1,-1,0],[1,1,0])
    q = np.array([0,0,0])
